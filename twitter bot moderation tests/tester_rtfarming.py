...
if __name__ == "__main__":
    ...
    print("\nThere are 6 tweets from the same user. Since tweet threshold = 5, none of those tweets will be retweeted. ", flush=True)
    ...
    print("\nThere are 5 tweets from the same user. Since tweet threshold = 5, only the first 2 tweets will be retweeted.", flush=True)
